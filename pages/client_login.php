...
<body>
    <div class="loginbox">
        <img src="../assets/images/av.png" class="avatar">
        <h1>Login Here</h1>
        <form action="client_login.php" method="POST">
            ...
            <a href="../pages/client_registration.php"><strong>New User? Register Here</strong> <a href="../index.php"><i class="fa fa-home"></i>&nbsp;<strong>Home</strong></a></a>
        </form>     
    </div>
</body>
